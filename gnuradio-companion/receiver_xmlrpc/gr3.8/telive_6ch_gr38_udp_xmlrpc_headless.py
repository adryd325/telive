...
class top_block(gr.top_block):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "SQ5BPF Tetra live receiver 6ch UDP HEADLESS")
        ...
        self.mmse_resampler_xx_5 = filter.mmse_resampler_cc(0, float(float(if_samp_rate)/float(out_sample_rate)))
        self.mmse_resampler_xx_4 = filter.mmse_resampler_cc(0, float(float(if_samp_rate)/float(out_sample_rate)))
        self.mmse_resampler_xx_3 = filter.mmse_resampler_cc(0, float(float(if_samp_rate)/float(out_sample_rate)))
        self.mmse_resampler_xx_2 = filter.mmse_resampler_cc(0, float(float(if_samp_rate)/float(out_sample_rate)))
        self.mmse_resampler_xx_1 = filter.mmse_resampler_cc(0, float(float(if_samp_rate)/float(out_sample_rate)))
        ...
        self.blocks_udp_sink_0_4 = blocks.udp_sink(gr.sizeof_gr_complex*1, udp_dest_addr, first_port+5, udp_packet_size, False)
        self.blocks_udp_sink_0_3 = blocks.udp_sink(gr.sizeof_gr_complex*1, udp_dest_addr, first_port+6, udp_packet_size, False)
        self.blocks_udp_sink_0_2 = blocks.udp_sink(gr.sizeof_gr_complex*1, udp_dest_addr, first_port+4, udp_packet_size, False)
        ...
        self.connect((self.analog_agc3_xx_0_0, 0), (self.mmse_resampler_xx_4, 0))
        self.connect((self.analog_agc3_xx_0_0_0, 0), (self.mmse_resampler_xx_3, 0))
        self.connect((self.analog_agc3_xx_0_0_0_0, 0), (self.mmse_resampler_xx_2, 0))
        self.connect((self.analog_agc3_xx_0_0_0_0_0, 0), (self.mmse_resampler_xx_0, 0))
        self.connect((self.analog_agc3_xx_0_0_0_0_0_0, 0), (self.mmse_resampler_xx_1, 0))
        ...
        self.connect((self.mmse_resampler_xx_0, 0), (self.blocks_udp_sink_0_4, 0))
        self.connect((self.mmse_resampler_xx_1, 0), (self.blocks_udp_sink_0_3, 0))
        self.connect((self.mmse_resampler_xx_2, 0), (self.blocks_udp_sink_0_2, 0))
        self.connect((self.mmse_resampler_xx_3, 0), (self.blocks_udp_sink_0_1, 0))
        self.connect((self.mmse_resampler_xx_4, 0), (self.blocks_udp_sink_0_0, 0))
        self.connect((self.mmse_resampler_xx_5, 0), (self.blocks_udp_sink_0, 0))
    ...
    def set_out_sample_rate(self, out_sample_rate):
        ...
        self.mmse_resampler_xx_1.set_resamp_ratio(float(float(self.if_samp_rate)/float(self.out_sample_rate)))
        self.mmse_resampler_xx_2.set_resamp_ratio(float(float(self.if_samp_rate)/float(self.out_sample_rate)))
        self.mmse_resampler_xx_3.set_resamp_ratio(float(float(self.if_samp_rate)/float(self.out_sample_rate)))
        self.mmse_resampler_xx_4.set_resamp_ratio(float(float(self.if_samp_rate)/float(self.out_sample_rate)))
        self.mmse_resampler_xx_5.set_resamp_ratio(float(float(self.if_samp_rate)/float(self.out_sample_rate)))
